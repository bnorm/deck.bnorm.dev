...
val KotlinLogos.OneColorWhite: ImageVector
    get() {
        if (_OneColorWhite != null) {
            return _OneColorWhite!!
        }
        _OneColorWhite = Builder(name = "OneColorWhite",
...
private var _OneColorWhite: ImageVector? = null
