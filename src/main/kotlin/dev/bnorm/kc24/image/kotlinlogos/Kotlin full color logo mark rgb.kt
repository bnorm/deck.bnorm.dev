...
public val dev.bnorm.kc24.image.KotlinLogos.`Kotlin full color logo mark rgb`: ImageVector
    get() {
        if (`_kotlin full color logo mark rgb` != null) {
            return `_kotlin full color logo mark rgb`!!
        }
        `_kotlin full color logo mark rgb` = Builder(name = "Kotlin full color logo mark rgb",
...
private var `_kotlin full color logo mark rgb`: ImageVector? = null
