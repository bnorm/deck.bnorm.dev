...
public val dev.bnorm.kc24.image.KotlinLogos.`Kotlin full color logo on black rgb`: ImageVector
    get() {
        if (`_kotlin full color logo on black rgb` != null) {
            return `_kotlin full color logo on black rgb`!!
        }
        `_kotlin full color logo on black rgb` = Builder(name = "Kotlin full color logo on black rgb", defaultWidth = 2435.0.dp, defaultHeight = 528.0.dp, viewportWidth = 2435.0f,
            ...
            path(fill = SolidColor(Color(0xFFFFFFFF)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(15.7f, 11.0f, 28.2f, 25.1f, 37.6f, 42.3f)
                curveToRelative(9.4f, 18.8f, 12.5f, 39.2f, 12.5f, 62.7f)
                reflectiveCurveTo(1378.8f, 382.0f, 1369.4f, 400.8f)
                close()
            }
            path(fill = SolidColor(Color(0xFFFFFFFF)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
...
private var `_kotlin full color logo on black rgb`: ImageVector? = null
