...
val KotlinLogos.MonochromeBlack: ImageVector
    get() {
        if (_MonochromeBlack != null) {
            return _MonochromeBlack!!
        }
        _MonochromeBlack = Builder(name = "MonochromeBlack",
...
private var _MonochromeBlack: ImageVector? = null
