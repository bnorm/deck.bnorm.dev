...
fun KotlinConfBird(visible: Transition<Boolean>): VectorPainter = rememberVectorPainter(
    ...
    Group(name = "head", translationX = birdHeadTranslation) {
        Path(stroke = paint19_linear_12_2, strokeLineWidth = 4f, strokeAlpha = birdAlpha, pathData = PathData {
    ...
    Group(name = "body", translationX = birdBodyTranslation) {
        Path(stroke = paint20_linear_12_2, strokeLineWidth = 4f, strokeAlpha = birdAlpha, pathData = PathData {
            moveTo(630.64f, 717f)
...
private val paint0_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0f to Color(0xFFFF9419),
        0.4f to Color(0xFFFF021D),
        1f to Color(0xFFE600FF)
    ),
...
private val paint2_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0f to Color(0xFFFF9419),
        0.4f to Color(0xFFFF021D),
        0.64f to Color(0x00F70169),
        0.68f to Color(0xFFF4017E),
        0.81f to Color(0xFFF001A4),
        0.85f to Color(0x00EE01B3),
...
private val paint4_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0f to Color(0xFFFF9419),
        0.4f to Color(0xFFFF021D),
        0.65f to Color(0x00F5017B),
        0.67f to Color(0xFFF1019A),
        0.76f to Color(0xFFEC01C6),
        0.79f to Color(0x00EA00D7),
        1f to Color(0xFFE600FF)
    ),
...
private val paint6_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0f to Color(0xFFFF9419),
        0.34f to Color(0xFFFF021D),
        0.63f to Color(0x00F70169),
        0.67f to Color(0xFFF40181),
        0.96f to Color(0xFFE600FF)
    ),
...
private val paint7_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0f to Color(0x00FF9419),
        0.35f to Color(0x00FF021D),
        0.56f to Color(0xFFEC00CC),
        0.82f to Color(0x00ED01BB),
        0.89f to Color(0xFFE600FF)
    ),
...
private val paint8_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0f to Color(0x00FF9419),
        0.16f to Color(0x00FF021D),
        0.24f to Color(0x00FB0241),
        0.3f to Color(0xFFF90156),
        0.69f to Color(0xFFE600FF)
    ),
...
private val paint10_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0.0474716f to Color(0xFFFF9419),
        0.102406f to Color(0xFFFF9419),
        0.398382f to Color(0xFFFF021D),
        1f to Color(0xFFE600FF)
    ),
...
private val paint11_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0.15f to Color(0xFFFF9419),
        0.26f to Color(0x00FF801A),
        0.4f to Color(0x00FF021D),
...
private val paint15_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0f to Color(0xFFFF9419),
        0.4f to Color(0xFFFF021D),
        0.66f to Color(0x00EA00DF),
        0.69f to Color(0xFFE800E9),
        0.94f to Color(0xFFE600FF)
    ),
...
private val paint16_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0f to Color(0xFFFF9419),
        0.4f to Color(0xFFFF021D),
        0.87f to Color(0x00EA00D9),
        0.91f to Color(0xBEE900E5),
        0.93f to Color(0xFFE800E9),
        0.93f to Color(0xFFE600FF)
    ),
...
private val paint18_linear_12_2 = Brush.linearGradient(
    colorStops = arrayOf(
        0f to Color(0xFFFF9419),
        0.4f to Color(0xFFFF021D),
        0.69f to Color(0x00EA00DA),
        0.95f to Color(0xFFE600FF)
    ),
